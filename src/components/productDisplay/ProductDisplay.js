      ...
      <div className="mt-12 flex p-4 flex-col md:flex-row justify-between">
        ...
        <div id="product-listing" className="space-y-6 p-6 md:pr-12 md:w-1/2">
          ...
          <div className="flex space-x-6 pt-2">
            ...
            {showToast && (
  <div id="toast-success" className="fixed bottom-5 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400" role="alert">
    ...
    <div className="ml-3 text-brown text-sm font-normal">Item added to cart successfully.</div>
    <button type="button" className="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white" onClick={() => setShowToast(false)} aria-label="Close">
