...
<footer className="bg-white mt-12">
    ...
    <label for="small-input" class="block mb-2 text-md font-medium text-gray-900">Subscribe to our <br /> newsletter</label>
    <div className='flex items-center'>
    <input type="text" id="small-input" class="block md:w-full p-2 text-gray-900 border-b border-gray-300 text-xs  " placeholder='Email address' />
    <button className='bg-brown text-white font-bold px-4 py-1'>&gt;</button>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-brown font-medium space-y-4">
                      <li className="">
                          <a href="#g" className="hover:underline">Email Marketing</a>
                      </li>
                      <li >
                          <a href="#h" className="hover:underline">Campaigns</a>
                      </li>
                      <li>
                          <a href="#h" className="hover:underline">Branding</a>
                      </li>
              ...
              <div>
                  ...
                  <ul className="text-brown  font-medium">
                      <li className="mb-4">
                          <a href="#dse" className="hover:underline">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="#sw" className="hover:underline">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between md:justify-center mt-24 mb-2">
          <span className="text-brown sm:text-center"><a href="uy" className="hover:underline">© Copyright 2024 Zecado™</a>. All Rights Reserved.
          </span>
      </div>
    </div>
</footer>
